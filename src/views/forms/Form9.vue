  ...
  <div class="card mb-4">
    ...
    <div class="card-body px-0 pt-0 pb-2 m-4">
      <div class="row mb-3">
        ...
        <div class="col-md-3 mb-3">
          <label class="mb-2">Kredit nomi</label>
        ...
        <div class="col-md-3 mb-3">
          <label class="mb-2">Kredit shartnoma raqami</label>
          <input
              class="form-control"
              type="text"
      ...
      <div class="row mb-3">
        ...
        <div class="col-md-3 mb-3">
          <label class="mb-2">Pul birligi</label>
          <select class="form-select">
            <option selected>Tanlang...</option>
            <option value="FEMALE">2023</option>
          </select>
        ...
        <div class="col-md-3">
          <label class="mb-2">Hisoblangan foiz qiymati</label>
          <input
              class="form-control"
              type="text"
              placeholder="Kiriting"
