  ...
  <div class="card mb-4">
    ...
    <div class="card-body px-0 pt-0 pb-2 m-4">
      ...
      <div class="row">
        ...
        <div class="col-md-4 mb-3">
          <label>Ish haqi berilish maqsadi</label>
          <select class="form-select">
            <option selected>Tanlang...</option>
            <option value="FEMALE">2023</option>
          </select>
        ...
        <div class="col-md-4">
          <label class="mb-2">Hisoblangan ish haqi</label>
          <input
              class="form-control"
              type="text"
              placeholder="Kiriting"
      ...
      <div class="row mb-4">
        <div class="col-md-4 pt-3 mb-3">
          <div class="row mt-4">
            <div class="col-md-5">
              <label>Yagona ijtimoiy to'lov: </label>
            </div>
            <div class="col-md-3">
        ...
        <div class="col-md-4">
          <label class="mb-2">Yagona ijtimoiy to'lov qiymati</label>
          <input
              class="form-control"
              type="text"
              placeholder="Kiriting"
        ...
        <div class="col-md-4">
          <label class="mb-2">Jami qiymat</label>
          <input
              class="form-control"
              type="text"
              placeholder="Kiriting"
